...
import mk.ukim.finki.organisation.sharedkernel.domain.base.IdentifyableDomainObject;
...
class ProcessedRemoteEvent implements IdentifyableDomainObject<String> {
